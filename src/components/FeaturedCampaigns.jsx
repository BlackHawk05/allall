        ...
        <div className='col-span-12 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-6'>
            ...
            <div className='px-6 pt-6 pb-7.5'>
                ...
                <div className='mb-5.5 flex flex-wrap items-center gap-3.5'>
                    <button
                        className={`inline-flex items-center gap-3 rounded-md border py-2 px-4.5 font-medium hover:border-primary hover:bg-primary/[0.08] hover:text-primary ${openTab === 1 ? activeClasses : inactiveClasses
                            }`}
                    ...
                    <button
                        className={`inline-flex items-center gap-3 rounded-md border py-2 px-4.5 font-medium hover:border-primary hover:bg-primary/[0.08] hover:text-primary ${openTab === 2 ? activeClasses : inactiveClasses
                            }`}
                    ...
                    <button
                        className={`inline-flex items-center gap-3 rounded-md border py-2 px-4.5 font-medium hover:border-primary hover:bg-primary/[0.08] hover:text-primary ${openTab === 3 ? activeClasses : inactiveClasses
                            }`}
                    ...
                    <button
                        className={`inline-flex items-center gap-3 rounded-md border py-2 px-4.5 font-medium hover:border-primary hover:bg-primary/[0.08] hover:text-primary ${openTab === 4 ? activeClasses : inactiveClasses
                            }`}
                ...
                <div>
                    ...
                    <div
                        className={`mt-4.5 flex flex-col gap-6 ${openTab === 1 ? 'block' : 'hidden'
                            }`}
                    >
                    ...
                    <div
                        className={`mt-4.5 flex flex-col gap-6 ${openTab === 2 ? 'block' : 'hidden'
                            }`}
                    >
                        {/* <!-- Featured Tab Content Item --> */}
                        <div className='grid gap-1 px-4.5 xsm:grid-cols-7 sm:grid-cols-5'>
                    ...
                    <div
                        className={`mt-4.5 flex flex-col gap-6 ${openTab === 3 ? 'block' : 'hidden'
                            }`}
                    >
                        {/* <!-- Featured Tab Content Item --> */}
                        <div className='grid gap-1 px-4.5 xsm:grid-cols-7 sm:grid-cols-5'>
                    ...
                    <div
                        className={`mt-4.5 flex flex-col gap-6 ${openTab === 4 ? 'block' : 'hidden'
                            }`}
                    >
                        {/* <!-- Featured Tab Content Item --> */}
                        <div className='grid gap-1 px-4.5 xsm:grid-cols-7 sm:grid-cols-5'>
