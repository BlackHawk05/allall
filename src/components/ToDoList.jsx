                ...
                <div className='px-4 py-4 md:px-6 md:py-6 xl:px-7.5'>
                    <div className='flex flex-col gap-6'>
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <span className='rounded bg-meta-3/[0.08] py-1.5 px-2.5 text-sm font-medium text-meta-3'>
                                Completed
                            </span>
                        </div>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex flex-grow items-center gap-4.5'>
                                <div className='hidden h-15 w-full max-w-15 items-center justify-center rounded-full border border-stroke bg-gray dark:border-strokedark dark:bg-meta-4 xsm:flex'>
                                    <svg
                                        ...
                                        xmlns='http://www.w3.org/2000/svg'
                                    >
                                        <g clipPath='url(#clip0_605_15127)'>
                                            <path
                            ...
                            <span className='rounded bg-primary/[0.08] py-1.5 px-2.5 text-sm font-medium text-primary'>
                                Upcoming
                            </span>
                        </div>
                        ...
                        <div className='flex items-center justify-between'>
                            <div className='flex flex-grow items-center gap-4.5'>
                                <div className='hidden h-15 w-full max-w-15 items-center justify-center rounded-full border border-stroke bg-gray dark:border-strokedark dark:bg-meta-4 xsm:flex'>
                                    <svg
                                        ...
                                        xmlns='http://www.w3.org/2000/svg'
                                    >
                                        <g clipPath='url(#clip0_605_15132)'>
                                            <path
                            ...
                            <span className='rounded bg-red/[0.08] py-1.5 px-2.5 text-sm font-medium text-red'>
                                Canceled
                            </span>
                        </div>
                    </div>
