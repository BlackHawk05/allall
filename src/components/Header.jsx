...
const Header = (
    ...
    return (
        <header className='sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none'>
            <div className={'flex flex-grow items-center xl:justify-end sm:justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11'}>
                    ...
                    <form action='https://formbold.com/s/unique_form_id' method='POST'>
                        <div className='relative'>
                            ...
                            <input
                                ...
                                className='font-medium w-full bg-transparent pr-4 pl-9 focus:outline-none'
                            />
                        </div>
                    </form>
                </div>
