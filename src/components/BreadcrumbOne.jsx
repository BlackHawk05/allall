    ...
    return (
        <div class='rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark'>
            ...
            <div class='p-4 sm:p-6 xl:p-10'>
                <div class='rounded-md border border-stroke p-4 py-3 dark:border-strokedark sm:py-5.5 sm:px-6 xl:px-7.5'>
                    <nav>
                        <ol class='flex flex-wrap items-center gap-3'>
                            <li>
                                <Link
                                    class='flex items-center gap-3.5 font-medium text-black hover:text-primary dark:text-white dark:hover:text-primary'
                                    to='/'
                                >
                                    Home
                                </Link>
                            ...
                            <li>
                                <Link class='flex items-center gap-3 font-medium' to='#'>
                                    <svg
                                        class='fill-current'
                                        width='18'
                                        height='7'
