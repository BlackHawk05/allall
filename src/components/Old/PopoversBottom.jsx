            ...
            <div className='mt-10 text-center sm:mb-60'>
                <div className='relative inline-block'>
                    ...
                    <div
                        ...
                        className={`absolute top-full left-1/2 z-20 mt-3 w-max max-w-[311px] -translate-x-1/2 rounded bg-white drop-shadow-5 dark:bg-meta-4 ${popoversOpen === true ? 'block' : 'hidden'
                            }`}
                    >
