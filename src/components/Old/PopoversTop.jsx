            ...
            <div className='mt-10 text-center sm:mb-60'>
                <div className='relative inline-block'>
                    ...
                    <div
                        ...
                        className={`absolute bottom-full left-1/2 z-20 mb-3 w-max max-w-[311px] -translate-x-1/2 rounded bg-white drop-shadow-5 dark:bg-meta-4 ${popoversOpen === true ? 'block' : 'hidden'
                            }`}
                    >
