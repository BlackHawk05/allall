...
import InboxMenuList from '../components/InboxMenuList';
        ...
        <DefaultLayout>
            ...
            <div className='h-[calc(100vh-186px)] overflow-hidden sm:h-[calc(100vh-174px)]'>
                <div className='h-full rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark lg:flex'>
                    <div
                        className={`fixed top-22.5 bottom-0 z-999 flex w-[230px] -translate-x-[120%] flex-col rounded-md border border-stroke bg-white dark:border-strokedark dark:bg-boxdark lg:static lg:w-1/5 lg:translate-x-0 lg:border-none ${inboxSidebarToggle && '!translate-x-0 duration-300 ease-linear'
                            }`}
                    >
                        <button
                    ...
                    <div className='flex h-full flex-col border-l border-stroke dark:border-strokedark lg:w-4/5'>
                        ...
                        <div className='flex flex-col-reverse justify-between gap-6 py-4.5 pl-4 pr-4 sm:flex-row lg:pl-10 lg:pr-7.5'>
                            <div className='flex items-center gap-4'>
                                ...
                                <DropdownDefault className='text-right' />
                            </div>
